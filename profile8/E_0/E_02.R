...
idx <- setdiff(1:ncol(box), grep("E_0", colnames(box)))
profile_design(
  E_01=seq(300,10600,length=profile_pts),
...
bake(file =paste0(out_dir,"profile_E_02.rds"), {
  
  cat(capture.output(sessionInfo()),
      file=paste0(out_dir,"sessionInfo_E_02.txt"),sep="\n")
