...
idx <- setdiff(1:ncol(box), grep("A_0", colnames(box)))
profile_design(
  A_01=seq(1150,15000,length=profile_pts),
...
bake(file =paste0(out_dir,"profile_A_0.rds"), {
  
  cat(capture.output(sessionInfo()),
      file=paste0(out_dir,"sessionInfo_A_0.txt"),sep="\n")
