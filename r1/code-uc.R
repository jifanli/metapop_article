# a version of code.R adapted for the unconstrained model, denoted uc
...
mle_contracted <- spatPomp::contract_params(mle,expanded=c(
 ...
 'Beta_be','Beta_af','Z_be','Z_af','D_be','D_af','Td_be','Td_af','mu_be','mu_af','tau', 'sigma_SE','theta'),
  U=373)
